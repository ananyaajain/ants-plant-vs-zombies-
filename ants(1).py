...
class Ant(Insect):
    ...
    def __init__(self, health=1):
        """Create an Insect with a quantity."""
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not bees and not place.is_hive: 
            ...
            x += 1
        return random_bee(bees)  #Replace this line
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        elif self.slowed and self.turns_slowed>0: 
            self.turns_slowed -= 1
            if self.turns_slowed>=0 and gamestate.time % 2 == 0: 
                if self.scared_turns>0 and not self.place.entrance.is_hive: 
                    self.move_to(self.place.entrance)
                    self.scared_turns -= 1
                else: 
                    self.move_to(destination)

        elif self.scared and self.scared_turns>0 and not self.place.entrance.is_hive: 
            if gamestate.time % 2 == 0 and self.scared_turns>=0: 
                self.move_to(self.place.entrance)
                self.scared_turns -= 1 
    ...
    def scare(self, length):
        ...
        """
        # BEGIN Problem EC
        if not self.scared and not self.scared_before: 
